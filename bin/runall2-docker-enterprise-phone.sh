...
#nohup ./channelmsg -f=../etc/channelmsg2.yaml >> ../logs/channelmsg.log  2>&1 &
#sleep 1

#echo "run channelmsg2 ..."
#nohup ./channelmsg2 -f=../etc/channelmsg2.yaml >> ../logs/channelmsg2.log  2>&1 &
#sleep 1
...
echo "run session ..."
nohup ./session -f=../etc/session-enterprise-phone.yaml >> ../logs/session.log  2>&1 &
sleep 5
...
#echo "run tgme ..."
#nohup ./tgme -f=../etc/tgme.yaml >> ../logs/tgme.log  2>&1 &
#sleep 1
...
echo "run turnserver ..."
turnserver -v -r 192.168.10.106:3478 -a -o -c ../etc/turnserver.conf --log-file ../logs/turnserver.log
