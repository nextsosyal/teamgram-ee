...
git clone https://repo.teamgram.io/teamgram-server/channels.git
git clone https://repo.teamgram.io/teamgram-server/channelcalls.git
git clone https://repo.teamgram.io/teamgram-server/stories.git
git clone https://repo.teamgram.io/teamgram-server/bots.git
cd teamcalls-server/third_party2
